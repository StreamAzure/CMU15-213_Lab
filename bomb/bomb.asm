...
0000000000400efc <phase_2>:
  ...
  400f1e:	74 05                	je     400f25 <phase_2+0x29>; 如果eax不等于(%rbx)，爆炸
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi ;%d %d（结合爆炸条件可以确定是2个）
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt> ;将输入的两个数存入rsp+8和rsp+12
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> 
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb> ;如果eax<=1，爆炸
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) ;如果第一个数的低4个字节大于7，爆炸
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax ;将第一个数保存到eax
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) ;跳转到(0x402470+8*eax)处
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax ;输入的第二个数要和eax相等
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax ;eax=14,6
  400fd4:	29 f0                	sub    %esi,%eax ;eax=14,6
  400fd6:	89 c1                	mov    %eax,%ecx ;ecx=14,6
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx ;右移31位，相当于取ecx的符号位，为0
  400fdb:	01 c8                	add    %ecx,%eax ;eax=14,6
  400fdd:	d1 f8                	sar    %eax ;右移1位，相当于除以2，eax=7,3
...
0000000000401062 <phase_5>:
  ...
  4010c2:	85 c0                	test   %eax,%eax             ; 当eax=0时
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> ; 跳转至 4010d9
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx ;将%rdi指向的字符串赋值给%rbx
...
000000000040145c <read_six_numbers>: ; sscanf需要8个参数，依次存放在rdi rsi rdx rcx r8 r9 rsp+8 rsp+16中
  ...
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp); 将rax的值存入rsp+8的位置
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax ; rax = rsi+16
  401474:	48 89 04 24          	mov    %rax,(%rsp) ; 将rax的值存入rsp的位置
  ...
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt> ;返回值为成功赋值的字段个数，存入%eax
  40148f:	83 f8 05             	cmp    $0x5,%eax ; 
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d> ; eax（从字符串中读取的数字个数） > 5 则跳转，安全
  401494:	e8 a1 ff ff ff       	call   40143a <explode_bomb>
  401499:	48 83 c4 18          	add    $0x18,%rsp ; 释放栈帧
  40149d:	c3                   	ret    
